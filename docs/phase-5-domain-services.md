...
Phase 5 已完成低耦合领域服务核心重构：用户资料查询与更新、好友与黑名单同步、群组与群成员同步、文件摘要、分片、断点续传状态和上传进度计算均已落地并通过单元测试。Phase 4 的真实 OpenIM server Gate 仍保持未通过状态；真实服务端收发、真实上传端点、持久化适配和 Session 生命周期装配不在本阶段冒充完成，会继续留到后续真实集成 Gate。
...
<!-- code-ref: phase5-user-service -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/user.rs#L26 -->
...
<!-- code-ref: phase5-user-update-profile -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/user.rs#L41 -->
...
<!-- code-ref: phase5-user-get-profiles -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/user.rs#L69 -->
...
<!-- code-ref: phase5-relation-service -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/relation.rs#L32 -->
...
<!-- code-ref: phase5-sync-friends -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/relation.rs#L79 -->
...
<!-- code-ref: phase5-sync-blacklist -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/relation.rs#L134 -->
...
<!-- code-ref: phase5-group-service -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/group.rs#L33 -->
...
<!-- code-ref: phase5-sync-groups -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/group.rs#L60 -->
...
<!-- code-ref: phase5-group-member-cleanup -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/group.rs#L81 -->
...
<!-- code-ref: phase5-sync-group-members -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/group.rs#L111 -->
...
<!-- code-ref: phase5-plan-multipart -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/file.rs#L58 -->
...
<!-- code-ref: phase5-resume-plan -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/file.rs#L89 -->
...
<!-- code-ref: phase5-mark-uploaded -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/file.rs#L100 -->
...
<!-- code-ref: phase5-upload-progress -> file:///Volumes/ssd/Users/hj/Documents/code/github/openim/openim-sdk-core-rust/crates/openim-domain/src/file.rs#L114 -->
...
当前已完成：用户资料查询与更新、批量用户资料查询、好友 owner 作用域同步、黑名单 owner 作用域同步、群组同步、群成员 group 作用域同步、群删除时成员清理、文件摘要模型、分片计划、断点续传状态恢复、上传分片状态推进、上传进度计算、领域层单元测试和全工作区回归。

当前未纳入 Phase 5 完成声明：真实 OpenIM server 兼容收发、真实上传 HTTP 端点、SQLite 与 IndexedDB 领域仓储适配、Session 生命周期装配、监听器回调派发。这些能力需要在 Phase 6 及后续真实集成 Gate 中继续验证。
